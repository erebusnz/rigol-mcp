    ...
    tools = [
        ...
        types.Tool(
            ...
            description=(
                ...
                "vars, backend hint, resource string, session state) followed by the "
                "scope's *IDN? string. If the *IDN? query fails, the connection block is "
                "still returned with the error — use it to spot LAN-vs-USB misconfig or "
                "an unreachable IP before assuming the scope itself is the problem. "
